...
#ifndef TRAVERSABILITY_LAYER
#define TRAVERSABILITY_LAYER
#include <mutex>
#include <string>
#include <vector>
...
protected:
   ...
   */
  void processMap(const nav2_msgs::msg::Costmap & new_map);
   ...
   */
  void incomingMap(const nav2_msgs::msg::Costmap::SharedPtr new_map);
  ...
  nav2_msgs::msg::Costmap::SharedPtr map_buffer_;
